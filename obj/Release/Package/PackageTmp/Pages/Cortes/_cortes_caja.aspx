...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dx:ASPxGridView ID="gvCortesAbiertos" runat="server" Width="100%" OnDataBinding="gvCortesAbiertos_DataBinding"
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn Caption="Acciones">
                <DataItemTemplate>
                    <dx:ASPxButton ID="btnCerrar" runat="server" Text="Descargar Detalle"
    ...
    <dx:ASPxCallbackPanel ID="cpMain" runat="server" Width="100%"
        ...
        <ClientSideEvents EndCallback="function (s,e){alert('corte realizado');gvCortesAbiertos.Refresh();}" />
